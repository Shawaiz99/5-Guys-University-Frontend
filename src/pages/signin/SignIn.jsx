...
function SignUp() {
  ...
  return (
<form onSubmit={handleSubmit} className="container form-signin shadow p-4 rounded">
   <div className="text-center mb-4">
    ...
    <button type="submit" className="btn btn-primary mt-2 p-2 w-100">Sign In</button>
